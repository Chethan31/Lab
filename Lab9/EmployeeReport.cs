...
namespace Lab9
{
    class EmployeeReport
    {
        ...
        public void DisplayEmployees(Employee[] Employees)
        {
            ...
            {
                count++;
                Console.WriteLine(emp.EmpId + "\t"+emp.Name+"\t"+ RoleBuilder.GetRoleDescription(emp.Role)+"\t"+emp.Basic+"\t"+emp.HRA+"\t"+SalaryCalculator.GetAllowance(emp)+"\t"+SalaryCalculator.GetSalary(emp));
            }
            //Write code here
